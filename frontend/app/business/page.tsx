...
export default function BusinessPortal() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <Web3Header isConnected={isConnected} address={address} onConnect={handleConnect} showSettings={true} />
          ...
          <div className="container mx-auto px-4 md:px-6 max-w-6xl py-12">
            <Web3Card className="max-w-2xl mx-auto">
              <CardHeader>
                ...
                <CardDescription>Please connect your wallet to access the business portal</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="rounded-lg bg-muted/50 p-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Connecting your wallet allows you to register and manage your ENS domains, control vendor
                    relationships, and maintain privacy for your business transactions.
                  </p>
                </div>
                      ...
                      <div className="rounded-lg bg-muted/50 p-4 space-y-3">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-start gap-2">
                            ...
                            <p className="text-sm text-muted-foreground">Your main wallet address remains private</p>
                          </div>
                          <div className="flex items-start gap-2">
                            <div className="mt-0.5 h-5 w-5 rounded-full bg-primary/20 flex items-center justify-center flex-shrink-0">
                            ...
                            <p className="text-sm text-muted-foreground">
                              Vendors will be automatically assigned unique resolved addresses
                            </p>
                          </div>
                          <div className="flex items-start gap-2">
                            <div className="mt-0.5 h-5 w-5 rounded-full bg-primary/20 flex items-center justify-center flex-shrink-0">
                            ...
                            <p className="text-sm text-muted-foreground">
                              All transactions are tracked and managed through our system
                            </p>
                          </div>
                        </div>
                      </div>

                      <Web3Button onClick={handleRegisterENS} className="w-full" disabled={!ensDomain}>
                        Register Domain
                      </Web3Button>
                    </div>
                  ) : (
                    <div className="space-y-6">
                      <div className="flex items-center justify-between p-4 rounded-lg bg-gradient-to-r from-primary/5 to-secondary/5 border border-primary/10">
                        <div className="space-y-1">
                          <p className="text-sm font-medium text-muted-foreground">Registered Domain</p>
                          <div className="flex items-center">
                            <p className="text-2xl font-bold gradient-text">{ensDomain}</p>
                      ...
                      <div className="grid gap-6 md:grid-cols-2">
                        <div className="space-y-2">
                          ...
                          <p className="text-xs text-muted-foreground">This address is kept private from vendors</p>
                        </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-2">
                        ...
                        <div>
                          ...
                          <CardDescription>
                            View and manage your vendor relationships and their resolved wallet addresses
                          </CardDescription>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="rounded-lg border overflow-hidden">
                        ...
                        {filteredVendors.map((vendor) => (
                          <div key={vendor.id} className="grid grid-cols-7 gap-4 p-4 items-center text-sm border-t">
                            <div className="font-medium">{vendor.name}</div>
                            <div className="font-mono text-xs">{vendor.address}</div>
                            <div className="font-mono text-xs">{vendor.resolvedWallet}</div>
                            <div>
                              <span
                              ...
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end">
                                  ...
                                  <DropdownMenuItem>
                                    ...
                                    {vendor.status === "active" ? "Disable" : "Enable"} Resolution
                                  </DropdownMenuItem>
                                </DropdownMenuContent>
                              </DropdownMenu>
                            </div>
      ...
      <footer className="border-t py-6 md:py-0">
        <div className="container flex flex-col items-center justify-between gap-4 md:h-24 md:flex-row px-4 sm:px-6 lg:px-8 mx-auto max-w-6xl">
          <div className="flex items-center space-x-2">
            ...
            <p className="text-center text-sm leading-loose text-muted-foreground">© 2024 BENS. All rights reserved.</p>
          </div>
